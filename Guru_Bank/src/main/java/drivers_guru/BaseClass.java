...
import utils_guru.WebEventListener;
...
public class BaseClass {
	...
	public BaseClass()
	{
		prop=new Properties();
		try {
			FileInputStream ip=new FileInputStream("C:\\Users\\SPURGE\\eclipse-workspace\\Guru_Bank\\Config\\config.properties");
			prop.load(ip);
